...
const Person = ({...actor}) => {
    ...
    return (
      <Link to={`/person/${id}`} className="cursor-pointer z-[999999999]">
          <div className='hover:scale-[1.06] transition-all duration-300 relative ml-[0.5rem] md:ml-0 md:mx-[0.5rem] md:w-[9.2rem]'>
          ...
          <div className='flex flex-col md:flex-row md:justify-between mt-[0.5rem] md:mt-1 md:gap-[0.5rem]'>
              <p className='text-light text-sm'>{job || known_for_department}</p>
              <p className="text-white text-sm flex flex-row-reverse md:flex-row gap-[0.2rem] items-center">
